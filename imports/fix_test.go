...
func TestLocalPrefix(t *testing.T) {
	saveImportToGroup := make([]func(importPath string) (num int, ok bool), len(importToGroup))
	copy(saveImportToGroup, importToGroup)
	defer func() { importToGroup = saveImportToGroup }()
